				...
				for($x = 0; $x < count($languages); $x++)
				{
					foreach($languages[$x] as $key => $value)
					{
						if($key == 'slug')
						{
							...
							?>
								<p>
									<label for="package_confirmation_message_<?php esc_html_e($value); ?>"><?php _e( 'Confirmation Message', 'dynamicpackages' ); ?> - <?php esc_html_e($value);?></label></br>
									<textarea cols="40" rows="6" type="text" name="package_confirmation_message_<?php esc_html_e($value); ?>" id="package_confirmation_message_<?php esc_html_e($value); ?>"><?php echo package_field( 'package_confirmation_message_'.$value ); ?></textarea>
								</p>	
							<?php
						}
					}	
					...
					for($x = 0; $x < count($languages); $x++)
					{
						foreach($languages[$x] as $key => $value)
						{
							if($key == 'slug')
							{
								...
								?>
									<p>
										<label for="package_child_title_<?php esc_html_e($value); ?>"><?php _e( 'Subpackage Short Title', 'dynamicpackages' ); ?> - <?php esc_html_e($value);?></label></br>
		...
		<?php if(!dy_validators::is_child()) : ?>
			<p>
				...
				<select name="package_display" id="package_display">
					<option value="0" <?php echo (package_field( 'package_display' ) == 0 ) ? 'selected' : ''; ?> ><?php _e( 'No', 'dynamicpackages' ); ?> (<?php echo (esc_html__('default', 'dynamicpackages')); ?>)</option>
			...
			<p>
				...
				<select name="package_fixed_price" id="package_fixed_price">
					<option value="0" <?php echo (package_field( 'package_fixed_price' ) == 0 ) ? 'selected' : ''; ?> ><?php _e( 'Yes', 'dynamicpackages' ); ?> (<?php echo (esc_html__('default', 'dynamicpackages')); ?>)</option>
					<option value="1" <?php echo (package_field( 'package_fixed_price' ) == 1 ) ? 'selected' : ''; ?> ><?php _e( 'No', 'dynamicpackages' ); ?> (<?php echo (esc_html__('fixed prices', 'dynamicpackages')); ?>)</option>				
				</select>
			</p>
