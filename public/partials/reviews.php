			...
			<div>
				...
				<div>
					<select name="dy_rating" class="bottom-20">
						<option value="5" <?php selected($selected, 5); ?>><?php echo self::get_stars(5); ?> - <?php echo (esc_html__('Excellent', 'dynamicpackages')); ?></option>
						<option value="4" <?php selected($selected, 4); ?>><?php echo self::get_stars(4); ?> - <?php echo (esc_html__('Good', 'dynamicpackages')); ?></option>
						<option value="3" <?php selected($selected, 3); ?>><?php echo self::get_stars(3); ?> - <?php echo (esc_html__('Average', 'dynamicpackages')); ?></option>
						<option value="2" <?php selected($selected, 2); ?>><?php echo self::get_stars(2); ?> - <?php echo (esc_html__('Bad', 'dynamicpackages')); ?></option>
						<option value="1" <?php selected($selected, 1); ?>><?php echo self::get_stars(1); ?> - <?php echo (esc_html__('Very Bad', 'dynamicpackages')); ?></option>
					</select>
				</div>
			</div>
		<?php
