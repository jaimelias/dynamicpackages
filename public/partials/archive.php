		...
		?>
			...
			<div class="bottom-40 pure-u-1 pure-u-sm-1-1 pure-u-md-1-<?php echo $cols_md; ?> pure-u-lg-1-<?php echo $cols; ?>" <?php if(dy_validators::is_valid_schema($post->ID)): ?> itemscope itemtype="http://schema.org/Product" <?php endif; ?>>
				...
				<?php if(dy_validators::is_valid_schema($post->ID)): ?>
					...
					<meta itemprop="sku" content="<?php esc_html_e(md5(package_field( 'package_trip_code' ))); ?>" />
					<meta itemprop="gtin8" content="<?php esc_html_e(substr(md5(package_field( 'package_trip_code' )), 0, 8)); ?>" />
				<?php endif; ?>
					...
					<div class="pure-g gutters">
						...
						<div class="pure-u-1 pure-u-md-<?php esc_html_e($break_md); ?> pure-u-lg-<?php esc_html_e($break_lg); ?>">
							...
							<div class="dy_package_title_h3">
								<h3 class="small"><a title="<?php esc_html_e($post->post_title); ?>" itemprop="url" href="<?php the_permalink(); ?>"><span itemprop="name"><?php esc_html_e($post->post_title); ?></span></a></h3>
							</div>
							...
							<div class="text-right strong uppercase hide-sm">
								<a href="<?php the_permalink(); ?>" title="<?php esc_html_e($post->post_title); ?>"><?php echo (esc_html__('More details', 'dynamicpackages')); ?> <span class="large"><span class="large"><i class="fas fa-chevron-circle-right"></i></span></span></a>
							</div>					
